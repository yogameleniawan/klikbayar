    ...
    return (
        <div className="flex flex-col items-center gap-2">
            ...
            <div className="max-w-[500px] gap-2 grid grid-cols-12 grid-rows-1 px-8 mt-2">
                <Card isFooterBlurred className="col-span-12 sm:col-span-4 hover:-translate-y-2">
                    <Link>
                        <Image
                            removeWrapper
                            alt="Card background"
                        ...
                        />
                        <CardFooter className="flex flex-col gap-2 text-center justify-between before:bg-white/10 border-white/20 border-1 overflow-hidden py-1 absolute before:rounded-xl rounded-large bottom-1 w-[calc(100%_-_8px)] shadow-small ml-1 z-10">
